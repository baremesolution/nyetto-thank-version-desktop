...
public class CylinderEllipticToConique extends JPanel {

    private float diam, longueur, flecheg, fleched;

    public CylinderEllipticToConique(float diam, float longueur, float fleched, float flecheg) {
        this.diam = diam;
...
// tracer des deux droites horizontales
        ...
        area.drawArc(this.getWidth() / 2 - 150, this.getHeight() / 20, 300, 120, 0, 180);//modifier

        area.drawLine(this.getWidth() / 2 - 150, 300 + this.getHeight() / 20, this.getWidth() / 2, 360 + this.getHeight() / 20);
        area.drawLine(this.getWidth() / 2 + 150, 300 + this.getHeight() / 20, this.getWidth() / 2, 360 + this.getHeight() / 20);
