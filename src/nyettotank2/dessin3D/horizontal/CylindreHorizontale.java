...
public class CylindreHorizontale extends JPanel {
    
    private float diam, longueur, flecheg, fleched;
    private String extremiteFlecheGauche = "";
    private String extremiteFlecheDroite = "";

    public CylindreHorizontale(float diam, float longueur, float flecheg, float fleched) {
        this.diam = diam;
    ...
    public CylindreHorizontale(float diam, float longueur, float flecheg, float fleched, String extremiteFeleche) {
        this.diam = diam;
        this.longueur = longueur;
        this.fleched = fleched;
        this.flecheg = flecheg;
    ...
    public CylindreHorizontale(float diam, float longueur, float flecheg, float fleched, String extremiteFelecheG, String extremiteFelecheD) {
        this.diam = diam;
        this.longueur = longueur;
        this.fleched = fleched;
        this.flecheg = flecheg;
