 ...
 */
public class CylindrePlatSphere extends JPanel {
 ...
 * Click nbfs://nbhost/SystemFileSystem/Templates/Classes/Class.java to edit this template
    ...
    public CylindrePlatSphere(float diam, float longueur) {
        this.diam = diam;
...
//nouvelle ligne
        ...
        area.drawArc(this.getWidth() - 100, 150 + this.getHeight() / 10, 300, 140, -90, 90);//modifier
